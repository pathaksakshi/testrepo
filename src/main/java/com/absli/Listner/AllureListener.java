...
import org.testng.*;
    ...
    public class AllureListener extends TestBase implements ITestListener, ISuiteListener, IInvokedMethodListener
    {
       ...
       // This belongs to ITestListener, It will Execute only when the Test is FAILED
        ...
        public void onTestFailure(ITestResult result)
        {
            ...
            AllureAttachments.saveFullPageScreenshot(Name, getDriver());
        }
