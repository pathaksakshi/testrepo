...
public class GoToPMSpage_MajorJourney {
	 Dashboard dashboard;
	    WaitUtils wait;
	    LoginPage loginPage;
	    ...
	    public void gotoPSM_Majorpage(WebDriver driver, HashMap<String, String> testData) throws InterruptedException, IOException {
