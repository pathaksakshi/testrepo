...
public class GoToPMSpageJointlife {
    Dashboard dashboard;
    WaitUtils wait;
    LoginPage loginPage;
    ...
    public void gotoPSM_Jointlifepage(WebDriver driver, HashMap<String, String> testData) throws InterruptedException, IOException {
