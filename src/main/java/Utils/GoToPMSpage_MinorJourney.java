...
public class GoToPMSpage_MinorJourney {
	 Dashboard dashboard;
	    WaitUtils wait;
	    LoginPage loginPage;
	...
	//------------------------------------------------------Same GMS------------------------------------------------------------------//
	    ...
	    public void gotoPSM_Minorpage(WebDriver driver, HashMap<String, String> testData) throws InterruptedException, IOException {
		    ...
		    customerprofile.Relationwithinsured(testData.get("Relationwithinsured"));
			customerprofile.Isinsurerminor(testData.get("IsMinor"));
			...
			dashboard.checkLoaderWeb();
			//customerprofile.PropDobmatchpopup();
