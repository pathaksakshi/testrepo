...
public class ViewQuoteFactoryFMP {
	...
	public void ViewPageFMP(WebDriver driver, HashMap<String, String> testData) throws InterruptedException, IOException {
		...
		// View Quote page //
		if (testData.get("IsPremiumAmountFMP").equalsIgnoreCase("YES")) {
			viewquote.EnterPremiumAmountWeb(testData.get("premiumamountFMP"));
		}
		if (testData.get("IsPlanOptionFMP").equalsIgnoreCase("YES")) {
			viewquote.SelectPlanoptWeb(testData.get("PlanOptionFMP"));
		}
		if (testData.get("IsPPTOptionFMP").equalsIgnoreCase("YES")) {
			viewquote.SelectPPTWeb(testData.get("pptFMP"));
		}
		if (testData.get("IsPolicyTermFMP").equalsIgnoreCase("YES")) {
			viewquote.EnterPolicytermWeb(testData.get("PolicyTermFMP"));
		}
